...
export default function NewInvoicePage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      router.push(`/dash/invoices/${created.id}`);
    } catch {
    ...
    <div className="max-w-2xl mx-auto">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          ...
          <p className="text-sm text-[#6b7280] mt-0.5">Create an invoice to send to a client.</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        {/* Due date */}
        <div className="bg-[#111111] border border-[#1f1f1f] rounded-2xl p-5">
          <label className="block text-sm font-semibold text-white mb-3">Due Date *</label>
          <input
            type="date"
            value={dueDate}
        ...
        {/* Notes */}
        <div className="bg-[#111111] border border-[#1f1f1f] rounded-2xl p-5">
          <label className="block text-sm font-semibold text-white mb-3">Notes</label>
          <textarea
            value={notes}
